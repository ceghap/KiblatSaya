...
svg_content = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="none">
  <!-- KiblatSaya Official App Icon (Obsidian Squircle + Milled Titanium Border + 2D Vector Sacred Compass) -->
  <rect width="512" height="512" rx="128" fill="#121316"/>
  <!-- Subtle Internal Glow / Border -->
  <rect x="6" y="6" width="500" height="500" rx="122" stroke="#27272A" stroke-width="8" fill="none"/>
  ...
  <!-- Top Qibla Apex Indicator (Sacred Emerald / White) -->
  ...
  <!-- Subtle Center Pillar of Light / Star -->
  <circle cx="256" cy="196" r="6" fill="#121316"/>
</svg>
"""
...
print("Icon generated successfully across all resolutions!")
